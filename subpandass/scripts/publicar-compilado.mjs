...
//
// Vite compila a subpandass/.build/ (carpeta temporal). Este script borra el
// resultado de la compilación anterior que hubiera en subpandass/ y mueve el nuevo
// en su lugar. Se hace así, y no compilando directamente sobre subpandass/, porque
// subpandass/ contiene también el código fuente (src/), los tests y el CHANGELOG:
...
console.log('Compilado publicado en subpandass/: index.html + assets/');
