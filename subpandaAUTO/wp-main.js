...
const translations = {
    ...
    es: {
        ...
        tour2Title: "2. Elige el modo de procesamiento",
        tour2Desc: "Groq es mucho más rápido y más eficiente pero requiere un API Key. El API Key de Groq es gratuito y podrás conseguirlo fácilmente dándole a \"GET KEY\". Groq enviará tu archivo a un servidor externo. Whisper es más lento y funciona localmente en tu PC.",
