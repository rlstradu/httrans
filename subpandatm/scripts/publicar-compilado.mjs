...
//
// Vite compila a subpandatm/.build/ (carpeta temporal). Este script borra el
// resultado de la compilación anterior que hubiera en subpandatm/ y mueve el nuevo
// en su lugar. Se hace así, y no compilando directamente sobre subpandatm/, porque
// subpandatm/ contiene también el código fuente (src/), los tests y el CHANGELOG:
...
console.log('Compilado publicado en subpandatm/: index.html + assets/');
