/**
 * Lo justo de XML para los formatos que lo usan: .resx de .NET, .ts de Qt y
 * .wxl de los instaladores WiX.
 *
 ...
 * escribiéndolo entero, que es justo lo que aquí no se quiere: reescribir un
 * .resx pierde el esquema que lleva dentro, y reescribir un .ts de Qt pierde
 * las líneas de código donde aparece cada texto. Estos formatos son archivos
 * generados por un programa, con una estructura muy repetida, así que se
 * recorren buscando los elementos que interesan y se anota dónde está cada
 * texto para poder sustituir solo eso.
 */
