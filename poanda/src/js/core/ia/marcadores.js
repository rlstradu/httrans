 ...
 *
 *     Pulsa ⟦0⟧ para guardar ⟦1⟧ahora⟦2⟧
 *
 ...
 * ninguna; si algo no cuadra, la traducción se descarta. **Es mejor un segmento
 * sin traducir que un archivo roto**, porque el primero se ve y el segundo no.
 */
 ...
 *
 * @param {string} texto
 * @param {{id: string, familias: string[]}} perfil Perfil de etiquetas del formato.
 * @returns {{texto: string, etiquetas: string[]}} El texto con marcas y qué
 *   había en cada una, por orden.
 */
export function ponerMarcas(texto, perfil) {
